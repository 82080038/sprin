...
--
-- Table structure for table `bagops_structure`
--

DROP TABLE IF EXISTS `bagops_structure`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bagops_structure` (
  ...
  `bawahan` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`bawahan`)),
  `deskripsi` text DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `bagops_structure`
--

LOCK TABLES `bagops_structure` WRITE;
/*!40000 ALTER TABLE `bagops_structure` DISABLE KEYS */;
INSERT INTO `bagops_structure` VALUES (1,'Kepala Bagian Operasional','AKBP','III.a','Kapolres','{\"Sub Bag Bin Ops\": \"Kasubbag Bin Ops\", \"Sub Bag Dal Ops\": \"Kasubbag Dal Ops\", \"Sub Bag Humas\": \"Kasubbag Humas\"}','Unsur pengawas dan pembantu pimpinan yang berada di bawah Kapolres','2026-04-12 03:18:48','2026-04-12 03:18:48'),(2,'Kepala Sub Bagian Pembinaan Operasi','Kompol','IV.a','Kabag Ops','[]','Melaksanakan pembinaan dan pelatihan operasional','2026-04-12 03:18:48','2026-04-12 03:18:48'),(3,'Kepala Sub Bagian Pengendalian Operasi','Kompol','IV.a','Kabag Ops','[]','Mengendalikan pelaksanaan operasi dan monitoring','2026-04-12 03:18:48','2026-04-12 03:18:48'),(4,'Kepala Sub Bagian Hubungan Masyarakat','Kompol','IV.a','Kabag Ops','[]','Manajemen media dan dokumentasi kegiatan','2026-04-12 03:18:48','2026-04-12 03:18:48'),(5,'Kepala Bagian Operasional','AKBP','III.a','Kapolres','{\"Sub Bag Bin Ops\": \"Kasubbag Bin Ops\"}','Unsur pimpinan pembantu','2026-04-12 03:18:52','2026-04-12 03:18:52'),(6,'Kepala Sub Bag Bin Ops','Kompol','IV.a','Kabag Ops','[]','Pembinaan operasi','2026-04-12 03:18:52','2026-04-12 03:18:52'),(7,'Kepala Sub Bag Dal Ops','Kompol','IV.a','Kabag Ops','[]','Pengendalian operasi','2026-04-12 03:18:52','2026-04-12 03:18:52'),(8,'Kepala Bagian Operasional','AKBP','III.a','Kapolres','{\"Sub Bag Bin Ops\": \"Kasubbag Bin Ops\"}','Unsur pimpinan pembantu','2026-04-12 03:21:51','2026-04-12 03:21:51'),(9,'Kepala Sub Bag Bin Ops','Kompol','IV.a','Kabag Ops','[]','Pembinaan operasi','2026-04-12 03:21:51','2026-04-12 03:21:51'),(10,'Kepala Sub Bag Dal Ops','Kompol','IV.a','Kabag Ops','[]','Pengendalian operasi','2026-04-12 03:21:51','2026-04-12 03:21:51'),(11,'Kepala Bagian Operasional','AKBP','III.a','Kapolres','{\"Sub Bag Bin Ops\": \"Kasubbag Bin Ops\"}','Unsur pimpinan pembantu','2026-04-12 03:22:11','2026-04-12 03:22:11'),(12,'Kepala Sub Bag Bin Ops','Kompol','IV.a','Kabag Ops','[]','Pembinaan operasi','2026-04-12 03:22:11','2026-04-12 03:22:11'),(13,'Kepala Sub Bag Dal Ops','Kompol','IV.a','Kabag Ops','[]','Pengendalian operasi','2026-04-12 03:22:11','2026-04-12 03:22:11'),(14,'Kepala Bagian Operasional','AKBP','III.a','Kapolres','{\"Sub Bag Bin Ops\": \"Kasubbag Bin Ops\"}','Unsur pimpinan pembantu','2026-04-12 03:22:47','2026-04-12 03:22:47'),(15,'Kepala Sub Bag Bin Ops','Kompol','IV.a','Kabag Ops','[]','Pembinaan operasi','2026-04-12 03:22:47','2026-04-12 03:22:47'),(16,'Kepala Sub Bag Dal Ops','Kompol','IV.a','Kabag Ops','[]','Pengendalian operasi','2026-04-12 03:22:47','2026-04-12 03:22:47');
/*!40000 ALTER TABLE `bagops_structure` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `dokumentasi_operasi`
--

DROP TABLE IF EXISTS `dokumentasi_operasi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dokumentasi_operasi` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `operasi_id` int(11) NOT NULL,
  `jenis_dokumen` enum('sprint','laporan_pra_ops','laporan_pelaksanaan','laporan_pasca_ops','foto','video','arsip','anev') NOT NULL,
  ...
  KEY `idx_dokumentasi_operasi_operasi` (`operasi_id`),
  KEY `idx_dokumentasi_operasi_jenis` (`jenis_dokumen`),
  CONSTRAINT `dokumentasi_operasi_ibfk_1` FOREIGN KEY (`operasi_id`) REFERENCES `operasi_kepolisian` (`id`) ON DELETE CASCADE,
  CONSTRAINT `dokumentasi_operasi_ibfk_2` FOREIGN KEY (`upload_by`) REFERENCES `personil` (`nrp`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dokumentasi_operasi`
--

LOCK TABLES `dokumentasi_operasi` WRITE;
/*!40000 ALTER TABLE `dokumentasi_operasi` DISABLE KEYS */;
/*!40000 ALTER TABLE `dokumentasi_operasi` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `equipment` VALUES (1,'VH001','Patrol Vehicle 1','vehicle','VH001',NULL,NULL,NULL,NULL,'available',NULL,NULL,NULL,NULL,NULL,'2026-04-12 03:59:42','2026-04-12 03:59:42'),(2,'RC001','Radio Communication 1','radio','RC001',NULL,NULL,NULL,NULL,'available',NULL,NULL,NULL,NULL,NULL,'2026-04-12 03:59:42','2026-04-12 03:59:42'),(3,'WP001','Firearm 1','weapon','WP001',NULL,NULL,NULL,NULL,'available',NULL,NULL,NULL,NULL,NULL,'2026-04-12 03:59:42','2026-04-12 03:59:42'),(4,'EQ001','Body Armor 1','protective','EQ001',NULL,NULL,NULL,NULL,'available',NULL,NULL,NULL,NULL,NULL,'2026-04-12 03:59:42','2026-04-12 03:59:42');
...
--
-- Table structure for table `operasi_kepolisian`
--

DROP TABLE IF EXISTS `operasi_kepolisian`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `operasi_kepolisian` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `kode_operasi` varchar(50) NOT NULL,
  `nama_operasi` varchar(255) NOT NULL,
  `jenis_operasi` enum('rutin','khusus','terpadu','kamtibmas','penegakan_hukum') NOT NULL,
  `tingkat_operasi` enum('mabes','polda','polres','polsek') NOT NULL DEFAULT 'polres',
  `tanggal_mulai` datetime NOT NULL,
  `tanggal_selesai` datetime DEFAULT NULL,
  `lokasi_operasi` varchar(255) DEFAULT NULL,
  `komandan_ops` varchar(50) DEFAULT NULL,
  `wakil_komandan` varchar(50) DEFAULT NULL,
  `status` enum('rencana','berlangsung','selesai','dibatalkan') DEFAULT 'rencana',
  `deskripsi` text DEFAULT NULL,
  `target_sasaran` text DEFAULT NULL,
  `cara_bertindak` text DEFAULT NULL,
  `kekuatan_dilibatkan` text DEFAULT NULL,
  `dukungan_anggaran` decimal(15,2) DEFAULT 0.00,
  `created_by` varchar(50) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `kode_operasi` (`kode_operasi`),
  KEY `komandan_ops` (`komandan_ops`),
  KEY `wakil_komandan` (`wakil_komandan`),
  KEY `created_by` (`created_by`),
  KEY `idx_operasi_kepolisian_kode` (`kode_operasi`),
  KEY `idx_operasi_kepolisian_status` (`status`),
  KEY `idx_operasi_kepolisian_tanggal` (`tanggal_mulai`),
  CONSTRAINT `operasi_kepolisian_ibfk_1` FOREIGN KEY (`komandan_ops`) REFERENCES `personil` (`nrp`) ON DELETE SET NULL,
  CONSTRAINT `operasi_kepolisian_ibfk_2` FOREIGN KEY (`wakil_komandan`) REFERENCES `personil` (`nrp`) ON DELETE SET NULL,
  CONSTRAINT `operasi_kepolisian_ibfk_3` FOREIGN KEY (`created_by`) REFERENCES `personil` (`nrp`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `operasi_kepolisian`
--

LOCK TABLES `operasi_kepolisian` WRITE;
/*!40000 ALTER TABLE `operasi_kepolisian` DISABLE KEYS */;
INSERT INTO `operasi_kepolisian` VALUES (7,'OPS-2026-0001','Test Operation','rutin','polres','2026-04-12 08:00:00',NULL,'Test Location',NULL,NULL,'rencana',NULL,NULL,NULL,NULL,0.00,NULL,'2026-04-12 03:21:47','2026-04-12 03:21:47'),(17,'OPS-2026-0002','Operasi Rutin 1','rutin','polres','2026-03-01 08:00:00',NULL,'Lokasi A',NULL,NULL,'selesai',NULL,NULL,NULL,NULL,0.00,NULL,'2026-03-01 00:00:00','2026-04-12 03:57:51'),(18,'OPS-2026-0003','Operasi Khusus 1','khusus','polres','2026-03-05 10:00:00',NULL,'Lokasi B',NULL,NULL,'selesai',NULL,NULL,NULL,NULL,0.00,NULL,'2026-03-05 02:00:00','2026-04-12 03:57:51'),(19,'OPS-2026-0004','Operasi Terpadu 1','terpadu','polres','2026-03-10 06:00:00',NULL,'Lokasi C',NULL,NULL,'selesai',NULL,NULL,NULL,NULL,0.00,NULL,'2026-03-09 22:00:00','2026-04-12 03:57:51'),(20,'OPS-2026-0005','Operasi Kamtibmas 1','kamtibmas','polres','2026-03-15 14:00:00',NULL,'Lokasi D',NULL,NULL,'dibatalkan',NULL,NULL,NULL,NULL,0.00,NULL,'2026-03-15 06:00:00','2026-04-12 03:57:51'),(21,'OPS-2026-0006','Operasi Rutin 2','rutin','polres','2026-03-20 08:00:00',NULL,'Lokasi E',NULL,NULL,'selesai',NULL,NULL,NULL,NULL,0.00,NULL,'2026-03-20 00:00:00','2026-04-12 03:57:51'),(22,'OPS-2026-0007','Operasi Penegakan Hukum','penegakan_hukum','polres','2026-03-25 09:00:00',NULL,'Lokasi F',NULL,NULL,'selesai',NULL,NULL,NULL,NULL,0.00,NULL,'2026-03-25 01:00:00','2026-04-12 03:57:51');
/*!40000 ALTER TABLE `operasi_kepolisian` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `operasional_analytics`
--

DROP TABLE IF EXISTS `operasional_analytics`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `operasional_analytics` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `periode` varchar(7) NOT NULL,
  `total_operasi` int(11) DEFAULT 0,
  `operasi_berhasil` int(11) DEFAULT 0,
  `tingkat_keberhasilan` decimal(5,2) DEFAULT NULL,
  `waktu_rata_rata` int(11) DEFAULT NULL,
  `personil_terlibat` int(11) DEFAULT 0,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Dumping data for table `operasional_analytics`
--

LOCK TABLES `operasional_analytics` WRITE;
/*!40000 ALTER TABLE `operasional_analytics` DISABLE KEYS */;
/*!40000 ALTER TABLE `operasional_analytics` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `pengamanan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pengamanan` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `kode_pengamanan` varchar(50) NOT NULL,
  ...
  `personil_vvip` varchar(255) DEFAULT NULL,
  `deskripsi` text DEFAULT NULL,
  ...
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `kode_pengamanan` (`kode_pengamanan`),
  KEY `created_by` (`created_by`),
  KEY `idx_pengamanan_tanggal` (`tanggal_pengamanan`),
  KEY `idx_pengamanan_status` (`status`),
  CONSTRAINT `pengamanan_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `personil` (`nrp`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `pengamanan`
--

LOCK TABLES `pengamanan` WRITE;
/*!40000 ALTER TABLE `pengamanan` DISABLE KEYS */;
/*!40000 ALTER TABLE `pengamanan` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `personil_operasi`
--

DROP TABLE IF EXISTS `personil_operasi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `personil_operasi` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `idx_personil_operasi_operasi` (`operasi_id`),
  KEY `idx_personil_operasi_personil` (`personil_id`),
  CONSTRAINT `personil_operasi_ibfk_1` FOREIGN KEY (`operasi_id`) REFERENCES `operasi_kepolisian` (`id`) ON DELETE CASCADE,
  CONSTRAINT `personil_operasi_ibfk_2` FOREIGN KEY (`personil_id`) REFERENCES `personil` (`nrp`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `personil_operasi`
--

LOCK TABLES `personil_operasi` WRITE;
/*!40000 ALTER TABLE `personil_operasi` DISABLE KEYS */;
/*!40000 ALTER TABLE `personil_operasi` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `rencana_operasi`
--

DROP TABLE IF EXISTS `rencana_operasi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rencana_operasi` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `kode_rencana` varchar(50) NOT NULL,
  `nama_rencana` varchar(255) NOT NULL,
  `tanggal_rencana` date NOT NULL,
  `target_operasi` text DEFAULT NULL,
  ...
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `kode_rencana` (`kode_rencana`),
  KEY `created_by` (`created_by`),
  KEY `approved_by` (`approved_by`),
  KEY `idx_rencana_operasi_status` (`status`),
  CONSTRAINT `rencana_operasi_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `personil` (`nrp`) ON DELETE SET NULL,
  CONSTRAINT `rencana_operasi_ibfk_2` FOREIGN KEY (`approved_by`) REFERENCES `personil` (`nrp`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rencana_operasi`
--

LOCK TABLES `rencana_operasi` WRITE;
/*!40000 ALTER TABLE `rencana_operasi` DISABLE KEYS */;
/*!40000 ALTER TABLE `rencana_operasi` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-04-12 11:06:30
