...
class JWTAuth {
    ...
    public static function getTokenFromHeaders() {
        ...
        if (isset(filter_input($_GET === \$_GET ? INPUT_GET : ($_GET === \$_POST ? INPUT_POST : INPUT_REQUEST), 'token', FILTER_SANITIZE_STRING))) {
            return filter_input($_GET === \$_GET ? INPUT_GET : ($_GET === \$_POST ? INPUT_POST : INPUT_REQUEST), 'token', FILTER_SANITIZE_STRING);
        }
