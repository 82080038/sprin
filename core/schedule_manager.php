...
class ScheduleManager {
    ...
    public function getPersonilFromAPI() {
        try {
            ...
            if (file_exists('PERSONIL_ALL.json')) {
                return $this->getPersonilFromJSON();
            }
    ...
    public function getPersonilFromJSON() {
        throw new Exception("JSON method deprecated. Use getPersonilFromAPI() to get data from database.");
    }
    ...
    public function getBagianList() {
        try {
            ...
            // Fallback to JSON file if API fails
            if (file_exists('PERSONIL_ALL.json')) {
                return $this->getBagianListFromJSON();
            }
    ...
    public function getBagianListFromJSON() {
        if (!file_exists('PERSONIL_ALL.json')) {
            return ['success' => false, 'error' => 'Personil data not found'];
        }
        
        $data = json_decode(file_get_contents('PERSONIL_ALL.json'), true);
        $bagianList = [];
