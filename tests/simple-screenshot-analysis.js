/**
 * Simple Layout Screenshot and Analysis Tool
 * Takes screenshots of all pages and analyzes layout structure
 */
        ...
        try {
            ...
            const analysis = await page.evaluate(() => {
                const results = {
                    ...
                    data_display: {
                        personil_count_element: document.querySelector('#totalPersonil') !== null,
            ...
            const analysis = await page.evaluate(() => {
                const results = {
                    ...
                    content_analysis: {
                        ...
                        badges_count: document.querySelectorAll('.badge').length,
...
if (require.main === module) {
    const analyzer = new SimpleLayoutAnalyzer();
    analyzer.runCompleteAnalysis().catch(console.error);
}

module.exports = SimpleLayoutAnalyzer;
