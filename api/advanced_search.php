...
$pdo = Database::getInstance()->getConnection();
    ...
    $unsur = isset($_GET['unsur']) ? $_GET['unsur'] : null;
    $bagian = isset($_GET['bagian']) ? $_GET['bagian'] : null;
    $kepegawaian = isset($_GET['kepegawaian']) ? $_GET['kepegawaian'] : null;
    $pangkat = isset($_GET['pangkat']) ? $_GET['pangkat'] : null;
    $status = isset($_GET['status']) ? $_GET['status'] : null;
    $jenis_kelamin = isset($_GET['jk']) ? $_GET['jk'] : null; // Updated to use JK
    $gelar = isset($_GET['gelar']) ? $_GET['gelar'] : null; // New filter
    $status_nikah = isset($_GET['status_nikah']) ? $_GET['status_nikah'] : null;
