...
Skill ini digunakan untuk membuat API endpoint CRUD (Create, Read, Update, Delete) baru dengan mengikuti pola yang sudah ada di aplikasi SPRIN v1.2.0.
...
└── {entity}_export.php     # Export functionality (PDF/Excel/CSV)
```

### Current API Examples (v1.2.0)
- **personil_crud.php**: Enhanced dengan validation dan auto-generation
- **jabatan_crud.php**: Card-based management system
- **user_management.php**: Role-based access control
- **backup_api.php**: Database backup operations
- **bulk_update_personil.php**: Bulk operations dengan JSON
